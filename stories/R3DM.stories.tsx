...
import { parsePathD, pathCommandsToPathD, View, ViewProps } from '../src';
...
const PATH_COMMANDS = parsePathD(PATH_D);
const REBUILT_PATH_D = pathCommandsToPathD(PATH_COMMANDS);
...
const Template: Story<ViewProps> = (args) => (
  <>
    Path Data:
    <br />
    <pre>{JSON.stringify(PATH_COMMANDS, null, 2)}</pre>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
      <path d={REBUILT_PATH_D} />
    </svg>
    <View {...args} />
  </>
);
